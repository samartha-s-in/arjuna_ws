...
// sweepy
//const double TICKS_PER_REVOLUTION = 3536; // For reference purposes.
//const double WHEEL_RADIUS = 0.055; // Wheel radius in meters
//const double WHEEL_BASE = 0.6; // Center of left tire to center of right tire
//const double TICKS_PER_METER = 17680; // Original was 2800

// scrubby
const double TICKS_PER_REVOLUTION = 4095; // For reference purposes.
...
const double TICKS_PER_METER = 20475; // Original was 2800
